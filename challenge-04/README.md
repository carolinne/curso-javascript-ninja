...
carro.adicionarPessoas = function (pessoa) {
  ...
  } else if (pessoa + carro.quantidadePessoas <= carro.assentos) {
...
carro.retirarPessoas = function (pessoa) {
  return carro.quantidadePessoas -= pessoa;
}
carro.retirarPessoas(4); // 1
